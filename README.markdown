...
- [The Official Gsabatie Swift Style Guide.](#the-official-gsabatie-swift-style-guide)
    - [Updated for Swift 4.2](#updated-for-swift-42)
  ...
  - [Code Organization](#code-organization)
    - [Protocol Conformance](#protocol-conformance)
      - [Marking protocols that are only satisfied by classes as class-protocols](#marking-protocols-that-are-only-satisfied-by-classes-as-class-protocols)
  ...
  - [Memory Management](#memory-management)
    ...
    - [Container Types Efficiently](#container-types-efficiently)
      - [Using value types in Array](#using-value-types-in-array)
      - [Using ContiguousArray with reference types when NSArray bridging is unnecessary](#using-contiguousarray-with-reference-types-when-nsarray-bridging-is-unnecessary)
